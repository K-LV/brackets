...
define(function (require, exports, module) {
    ...
    HTMLRewriter.prototype.elements = function(type, urlType) {
        ...
        function rewritePath(element) {
            ...
            element[urlType] = BlobUtils.getUrlStrict(Path.resolve(dir, path));
        }
    ...
    HTMLRewriter.prototype.links = function() {
        ...
        function rewritePath(element) {
            ...
            element.href = BlobUtils.getUrlStrict(Path.resolve(dir, path));
console.log("For " + path, " rewriting to " + element.href);
        }
